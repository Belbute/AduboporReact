...
const ProductCategories = () => {
  return (
    <div className="container mx-auto py-10 flex flex-col lg:flex-row gap-10">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:w-2/3 lg:grid-cols-3 lg:grid-rows-4 lg:gap-6 lg:grid-flow-col">
        <div className="bg-white rounded-lg lg:row-span-4">
          {/* Col 1 - xl Image */}
        ...
        {/* Col 2 - lg Image */}
        <div className="bg-green-200 rounded-lg lg:row-span-3">
          <div className="relative h-full bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <img
        ...
        {/* Col 2 - sm Image */}
        <div className="bg-red-200 rounded-lg lg:row-span-1">
          <div className="relative h-full bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <img
        ...
        {/* Col 3 - sm Image */}
        <div className="bg-teal-200 rounded-lg lg:row-spawn-1">
          <div className="relative h-full bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <img
              src={categories[2].image}
              loading="lazy"
        ...
        {/* Col 3 - sm Image */}
        <div className="bg-yellow-200 rounded-lg lg:row-span-3">
          <div className="relative h-full bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <img
              src={categories[2].image}
              loading="lazy"
