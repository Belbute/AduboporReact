...
const Hero = () => {
  ...
  return (
    <div
      className="relative flex items-center justify-center h-screen bg-cover bg-center -translate-y-20"
      id="Hero"
      style={{
          ...
          <div className="h-[40%] flex items-center justify-center">
            <ScrollParallax isAbsolutelyPositioned={false} strength={0.1}>
              <div className="combined-parallax-container">
                ...
                />
                <div className="hero-content text-center text-textColors-Dark px-5 z-10">
                  <div className="mb-10">
                  ...
                  <a
                    href="#Products"
                    className="inline-block text-sm px-6 py-2 md:text-lg bg-app-3 hover:scale-[115%] text-textColors-light font-semibold rounded-full transition duration-300 ease-in hover:text-white"
                  >
                    Produtos
                  </a>
                </div>
